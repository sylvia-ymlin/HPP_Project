...
# Number of threads
N_array = [10, 20, 40, 80, 100, 200, 400, 800, 1000, 2000, 4000, 8000, 10000]
file_names = ["./input_data/ellipse_N_00010.gal",
             ...
             "./input_data/ellipse_N_04000.gal",
             "./input_data/ellipse_N_08000.gal",
             "./input_data/ellipse_N_10000.gal"]
